  ...
  return (
    <div className='flex justify-center mt-0 sm:mt-10'>
      <div className='py-[100px] px-[30px] sm:px-[40px] dark:bg-gray-800 bg-[#dcdcdc] md:rounded-2xl relative h-[500px] leading-[0.9] w-screen md:w-[90%]'>
        ...
        <h1 className='text-white text-[10rem] ml-[-20px] dark:text-gray-300 uppercase'>{products[0].largeText}</h1>
        ...
        <div>
          <a href={`/products/${products[0].Product_ID}`}>
            <button className='rounded-2xl py-[10px] px-[16px] bg-[#f02d34] dark:text-white text-black border-none mt-10 text-lg font-medium cursor-pointer z-[10000]' type='button'>Shop {products[0].Product_Name}</button>
          </a>
