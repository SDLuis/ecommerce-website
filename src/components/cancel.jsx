...
const Canceled = () => {
  return (
    <div className=' bg-white dark:bg-gray-700 h-[60vh]'>
      <div className='canceled w-[92%] md:w-[1000px] mt-[100px] h-[350px] m-auto p-4 md:p-[50px] rounded-[15px] flex justify-center items-center flex-col bg-red-900'>
