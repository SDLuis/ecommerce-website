...
export default function FooterComponent () {
  return (
    <div className='footer-container text-[#324d67] dark:text-gray-200 mt-40 text-center sm:mt-10 xl:mt-16 py-[30px] px-[10px] font-bold flex flex-col items-center justify-center gap-[10px]'>
