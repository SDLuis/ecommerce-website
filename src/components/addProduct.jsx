      ...
      <div className='w-[90%] sm:w-[80%] bg-white dark:bg-gray-800 rounded-md px-5 pb-5'>
        ...
        <div className='grid gap-6 mb-6 md:grid-cols-2'>
          ...
          <div>
            ...
            <select type='text' id='Product_Type' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' required=''> <option value=''>Headphones Type</option>
          ...
          <div>
            ...
            <input type='text' id='smallText' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Small text' required='' />
          </div>
          <div>
            <label htmlFor='midText' className='block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300'>Mid Text</label>
            <input type='text' id='midText' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Mid text' required='' />
          </div>
        </div>
        <div className='mb-6'>
          <label htmlFor='largeText' className='block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300'>Large Text</label>
          <input type='text' id='largeText' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Large text' required='' />
        </div>
        <div className='mb-6'>
        ...
        <button type='submit' className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>Save product</button>
      </div>
    </form>
